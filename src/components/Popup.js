...
const Popup = (props) => {
  ...
  return (
    <div id="popup" className={`popup ${hidden} text-xl text-slate-800`}>
      <div className="popHeading sticky top-2 z-40">
        <h1 className="font-alegreya font-semibold tracking-widest md:font-semibold text-xl md:text-2xl text-[#068c7d]">
          {project_name}
        </h1>
      ...
      <div className="poptoolTechs p-1 md:p-3">
        <p className="float-left text-white font-alegreya">
          Tools and Technologies :
        </p>
        {technologies &&
          technologies.map((techs, ind) => (
            <li
              className="font-diphel"
              data-aos="fade-left"
        ...
        {other_techs &&
          other_techs.map((techs, ind) => (
            <li
              className="font-diphel"
              data-aos="fade-left"
              data-aos-duration="400"
              data-aos-delay={ind * 50 + 200}
              key={techs}
            >
              {techs}
            </li>
